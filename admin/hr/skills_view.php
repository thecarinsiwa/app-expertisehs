<?php
/**
 * Liste des compétences - ExpertiseHS (vue dashboard)
 */
...
$table_view_table = 'skills';
$table_view_title = 'Compétences';
$table_view_module = 'hr';
$table_view_prefix = 'skills';
$table_view_entity = 'Compétence';
